...
```
pr-homepage/
├── index.html          … トップ（最新お知らせ5件・最新広報紙・ML参加QR）
...
| 3. 規約・規程 | `rules.html`（トップは導線のみ） |
| 4. お役立ち情報 | `useful.html` |
| 5. 広報ML参加QR | `index.html` の「メール配信」セクション |
...
```powershell
# リポジトリのルートで
# 1. data/news.csv と data/newsletters.csv を編集
# 2. ビルド
...
9. **ボタン** … 規約・規程 / お役立ち情報
10. **見出し** … 広報メーリングリスト
11. **画像** … `assets/qr-mailinglist.png` をアップロード
12. **ボタン** … Google グループ参加 URL
...
- **トップは最新情報のみ**（お知らせ5件・最新広報紙・主要導線・ML）
- **過去・詳細は別ページ**（お知らせ年月別、広報紙年別、規約一覧）
